...
export default function SkillsManagement() {
  ...
  const handleAddSkill = async () => {
    try {
      ...
      toast({
        title: "Error",
        description: error instanceof Error ? error.message : String(error) || "Failed to create skill. Please try again.",
        variant: "destructive"
      });
    }
  };
  ...
  const handleEditSkill = async () => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: error instanceof Error ? error.message : String(error) || "Failed to update skill. Please try again.",
        variant: "destructive"
      });
    }
  };
  ...
  const handleDeleteSkill = async () => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: error instanceof Error ? error.message : String(error) || "Failed to delete skill. Please try again.",
        variant: "destructive"
      });
    }
  };
  ...
  const handleAddCategory = async () => {
    try {
      ...
      toast({
        title: "Error",
        description: error instanceof Error ? error.message : String(error) || "Failed to create category. Please try again.",
        variant: "destructive"
      });
    }
  };
  ...
  const handleEditCategory = async () => {
    ...
    try {
      ...
      toast({ title: 'Error', description: error instanceof Error ? error.message : String(error) || 'Failed to update category', variant: 'destructive' });
    }
  };
  ...
  const handleDeleteCategory = async () => {
    ...
    try {
      ...
      toast({ title: 'Error', description: error instanceof Error ? error.message : String(error) || 'Failed to delete category', variant: 'destructive' });
    }
  };
